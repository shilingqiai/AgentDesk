...
class UnrelatedHandler:
    ...
    def __init__(self, state_manager: StateManager):
        ...
        self._default_replies = [
            "抱歉，我无法处理这个问题。我只能帮您处理IT工单调度相关的咨询和派单。请问您需要提交工单或者了解服务目录吗？",
            "很抱歉，我专门负责IT运维服务相关的工单处理。如果您想了解服务内容或提交工单，我很乐意为您提供帮助！",
            "对不起，这个问题超出了我的服务范围。我主要协助处理IT工单调度和相关技术咨询，有什么可以为您服务的吗？"
        ]
        self._reply_index = 0
    ...
    def set_business_context(self, service_name: str = "IT支持服务") -> None:
        """设置业务上下文，自定义回复中的服务名称"""
        self._default_replies = [
